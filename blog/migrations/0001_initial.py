# Generated by Django 3.2.20 on 2023-08-08 09:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_to_post', to='blog.post', verbose_name='Post')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ManyToManyField(related_name='categories', to='blog.Post', verbose_name='Post')),
            ],
            options={
